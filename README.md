...
![Alt text](SynchGaze_Transmiter/SynchGaze_Transmiter_v1.1.png?raw=true "SynchGaze Transmiter board.")
...
![Alt text](SynchGaze_Motor_Control/SynchGaze_Motor_Control_v1.1.png?raw=true "SynchGaze Motor Control board.") 
